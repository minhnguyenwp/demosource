...
/**
 ...
 <http://en.michaeluno.jp/vbbhaisan>
...
class AdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'vbbhaisan';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'vbbhaisan') {
    ...
    public static function instantiate($sTextDomain = 'vbbhaisan') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'vbbhaisan') {
    ...
    private function __doDummy() {
        __('The options have been updated.', 'vbbhaisan');
        __('The options have been cleared.', 'vbbhaisan');
        __('Export', 'vbbhaisan');
        __('Export Options', 'vbbhaisan');
        __('Import', 'vbbhaisan');
        __('Import Options', 'vbbhaisan');
        __('Submit', 'vbbhaisan');
        __('An error occurred while uploading the import file.', 'vbbhaisan');
        __('The uploaded file type is not supported: %1$s', 'vbbhaisan');
        __('Could not load the importing data.', 'vbbhaisan');
        __('The uploaded file has been imported.', 'vbbhaisan');
        __('No data could be imported.', 'vbbhaisan');
        __('Upload Image', 'vbbhaisan');
        __('Use This Image', 'vbbhaisan');
        __('Insert from URL', 'vbbhaisan');
        __('Are you sure you want to reset the options?', 'vbbhaisan');
        __('Please confirm your action.', 'vbbhaisan');
        __('The specified options have been deleted.', 'vbbhaisan');
        __('A problem occurred while processing the form data. Please try again.', 'vbbhaisan');
        __('Is it okay to send the email?', 'vbbhaisan');
        __('The email has been sent.', 'vbbhaisan');
        __('The email has been scheduled.', 'vbbhaisan');
        __('There was a problem sending the email', 'vbbhaisan');
        __('Title', 'vbbhaisan');
        __('Author', 'vbbhaisan');
        __('Categories', 'vbbhaisan');
        __('Tags', 'vbbhaisan');
        __('Comments', 'vbbhaisan');
        __('Date', 'vbbhaisan');
        __('Show All', 'vbbhaisan');
        __('Show All Authors', 'vbbhaisan');
        __('Powered by', 'vbbhaisan');
        __('Settings', 'vbbhaisan');
        __('Manage', 'vbbhaisan');
        __('Select Image', 'vbbhaisan');
        __('Upload File', 'vbbhaisan');
        __('Use This File', 'vbbhaisan');
        __('Select File', 'vbbhaisan');
        __('Remove Value', 'vbbhaisan');
        __('Select All', 'vbbhaisan');
        __('Select None', 'vbbhaisan');
        __('No term found.', 'vbbhaisan');
        __('Select', 'vbbhaisan');
        __('Insert', 'vbbhaisan');
        __('Use This', 'vbbhaisan');
        __('Return to Library', 'vbbhaisan');
        __('%1$s queries in %2$s seconds.', 'vbbhaisan');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'vbbhaisan');
        __('Peak memory usage %1$s MB.', 'vbbhaisan');
        __('Initial memory usage  %1$s MB.', 'vbbhaisan');
        __('The allowed maximum number of fields is {0}.', 'vbbhaisan');
        __('The allowed minimum number of fields is {0}.', 'vbbhaisan');
        __('Add', 'vbbhaisan');
        __('Remove', 'vbbhaisan');
        __('The allowed maximum number of sections is {0}', 'vbbhaisan');
        __('The allowed minimum number of sections is {0}', 'vbbhaisan');
        __('Add Section', 'vbbhaisan');
        __('Remove Section', 'vbbhaisan');
        __('Toggle All', 'vbbhaisan');
        __('Toggle all collapsible sections', 'vbbhaisan');
        __('Reset', 'vbbhaisan');
        __('Yes', 'vbbhaisan');
        __('No', 'vbbhaisan');
        __('On', 'vbbhaisan');
        __('Off', 'vbbhaisan');
        __('Enabled', 'vbbhaisan');
        __('Disabled', 'vbbhaisan');
        __('Supported', 'vbbhaisan');
        __('Not Supported', 'vbbhaisan');
        __('Functional', 'vbbhaisan');
        __('Not Functional', 'vbbhaisan');
        __('Too Long', 'vbbhaisan');
        __('Acceptable', 'vbbhaisan');
        __('No log found.', 'vbbhaisan');
    }
}